...
const METRIC_DESCRIPTIONS = {
  ...
  sprawling_commits_pct: {
    ...
    dora: 'DORA measured a 7.2% reduction in delivery stability and a 1.5% reduction in throughput for every 25% increase in AI adoption. Sprawl is one commit-level mechanism that could produce that; DORA does not measure files per commit itself.'
  },
  uncovered_prod_rate: {
