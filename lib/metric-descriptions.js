...
const METRIC_DESCRIPTIONS = {
  ...
  sprawling_commits_pct: {
    ...
    dora: 'DORA measured a 154% increase in pull request size where AI adoption is high. This is the same problem one step earlier, at the commit.'
  },
  uncovered_prod_rate: {
    ...
    dora: 'DORA found automated testing to be the single biggest factor in whether AI tools help or hurt a team.'
  },
  message_quality_pct: {
  ...
  p90_lines_changed: {
    ...
    dora: 'Small batches. Rising while commits also land faster is the volume without discipline pattern.'
  },
  p90_files_changed: {
  ...
  commit_size_trend: {
    ...
    dora: 'Commits growing while landing faster is the volume without discipline pattern, the early warning of drift.'
  },
  velocity_trend: {
    measures: 'Whether commits are landing faster or slower, comparing the first half of the period against the second.',
    dora: 'Speeding up while commits also grow is the volume without discipline pattern.'
  },
