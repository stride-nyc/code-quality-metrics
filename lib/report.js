...
// produced a verdict and how much evidence stands behind it: n=2 (both supporting
// repositories are also members of the five-repo eval set this toolkit's own maintainer uses
// day to day -- calibration/observations.json's greenfield-modern-eval-circularity
// reservation, GitHub #84) against the brownfield bands' n=12. lib/report-template.js reads
// this to render a visibly different tile, not the same-looking one a silent substitution
// would produce.
const GREENFIELD_MODERN_PROVENANCE = { population: 'greenfield-modern', n: 2 };
