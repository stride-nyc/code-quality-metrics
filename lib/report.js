...
// pass and reports it as unsupportedExtensions rather than a statistics object, so this catalog
 ...
 *
 * duplicates.unsupportedExtensions (code-quality-metrics-tjn) takes priority over
...
function buildDuplicationEntries(duplicates) {
  ...
  const unsupportedExtensions = duplicates.unsupportedExtensions;
