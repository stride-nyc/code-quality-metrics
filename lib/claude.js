 ...
 *
 * The additions ratio is judged on counted_additions/counted_deletions (exclusion-scoped),
 * not total_additions/total_deletions (whole-diff), so a commit that is almost entirely
 * excluded vendored/generated content does not score as a high-risk AI-drift candidate on
 * the strength of that excluded volume (code-quality-metrics-ce9m). Measured case (73V,
 * cc7c77aa): 14,679 total changed lines, 14,410 of them excluded terraform, 216 real
 * production lines.
