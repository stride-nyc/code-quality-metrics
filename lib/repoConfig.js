 ...
 * number).
 */
const CLASS_A_KEYS = new Set(['DUPLICATE_IGNORE_PATTERNS', 'TEST_FILE_PATTERNS']);
 ...
 * the next.
 *
 * @param {{ DUPLICATE_IGNORE_PATTERNS: Array<string>, TEST_FILE_PATTERNS: Array<RegExp>, DUPLICATE_MIN_LINES: number, DUPLICATE_MIN_TOKENS: number }} defaults
