...
/**
 * Build what is actually sent to the model for a given catalog: today this
 * is the catalog unchanged, so extracting it is behaviour-preserving. This
 * is the seam later work curates (rounding values, dropping internal
 * sort/rendering fields, adding descriptions) without touching the call
 * site or generateFindingsNarrative's signature.
