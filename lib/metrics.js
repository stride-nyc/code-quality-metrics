...
function classifyDoraArchetype(summary) {
  ...
  if (large < HARMONIOUS.large && sprawling < HARMONIOUS.sprawling && testCoverage > HARMONIOUS.testCoverage && uncoveredProd < HARMONIOUS.uncoveredProd) return 'harmonious-high-achiever';
