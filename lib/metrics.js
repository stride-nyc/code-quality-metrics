...
function classifyDoraArchetype(summary) {
  ...
  if (large > LARGE_COMMITS_PCT.critical) return 'foundational-challenges';
...
module.exports = { isTestFile, isExcludedPath, isRepoFurniture, matchesAnyPattern, scoreMessageQuality, classifyDoraArchetype, generateInsights };
