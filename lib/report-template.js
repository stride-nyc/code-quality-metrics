 ...
 * entry's own value/label/status or from summary.vendored_generated_share -- there is no model
 * call and no free-form text in this function at all, so there is nothing in it that could
