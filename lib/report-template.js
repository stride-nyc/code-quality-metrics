...
function renderDuplicateSection(duplicates) {
  ...
  const semanticRan = Boolean(duplicates.layers_run && duplicates.layers_run.semantic);
  ...
  const layerIndicator = semanticRan
    ? 'Layer 1 (static) and Layer 2 (semantic) ran.'
    : 'Layer 1 (static) ran. Set ANTHROPIC_API_KEY to enable Layer 2 (semantic) analysis.';
