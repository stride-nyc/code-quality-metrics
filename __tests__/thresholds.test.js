...
// previously-adopted bands move, and test_coverage_rate, message_quality_pct
// and duplication_pct gain a real, observation-derived band for the first
// time. test_isolation_rate stays informational: derive-bands.js computes no
// healthy/critical for it, so its `positive` value is not calibration-derived),
// this test is updated to match, not weakened or deleted. See
